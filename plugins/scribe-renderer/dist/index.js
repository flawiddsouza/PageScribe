...
// src/editor.ts
function createCustomKeyMap(schema2) {
  const mac5 = typeof navigator != "undefined" ? /Mac|iP(hone|[oa]d)/.test(navigator.platform) : false;
  const customKeyMap = {};
  ...
  customKeyMap["Mod-b"] = toggleMark(schema2.marks.strong);
  customKeyMap["Mod-B"] = toggleMark(schema2.marks.strong);
  customKeyMap["Mod-i"] = toggleMark(schema2.marks.em);
  customKeyMap["Mod-I"] = toggleMark(schema2.marks.em);
...
function createEditor(mountPoint, fileContent, updateCallback) {
