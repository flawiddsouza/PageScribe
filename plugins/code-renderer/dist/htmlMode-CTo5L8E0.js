import { m as ft } from "./index-DVJfp3RD.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var lt = Object.defineProperty, gt = Object.getOwnPropertyDescriptor, ht = Object.getOwnPropertyNames, pt = Object.prototype.hasOwnProperty, vt = (e, r, i, n) => {
  if (r && typeof r == "object" || typeof r == "function")
    for (let t of ht(r))
      !pt.call(e, t) && t !== i && lt(e, t, { get: () => r[t], enumerable: !(n = gt(r, t)) || n.enumerable });
  return e;
}, mt = (e, r, i) => (vt(e, r, "default"), i), c = {};
mt(c, ft);
...
(function(e) {
  function r(n, t) {
    return n === Number.MAX_VALUE && (n = M.MAX_VALUE), t === Number.MAX_VALUE && (t = M.MAX_VALUE), { line: n, character: t };
  }
  e.create = r;
  function i(n) {
    let t = n;
...
(function(e) {
  function r(n, t, a, s) {
    if (o.uinteger(n) && o.uinteger(t) && o.uinteger(a) && o.uinteger(s))
      return { start: b.create(n, t), end: b.create(a, s) };
    if (b.is(n) && b.is(t))
      return { start: n, end: t };
    throw new Error(`Range#create called with invalid arguments[${n}, ${t}, ${a}, ${s}]`);
  }
  e.create = r;
  function i(n) {
    let t = n;
    return o.objectLiteral(t) && b.is(t.start) && b.is(t.end);
  }
  e.is = i;
})(h || (h = {}));
var C;
...
(function(e) {
  function r(n, t, a, s) {
    return { targetUri: n, targetRange: t, targetSelectionRange: a, originSelectionRange: s };
  }
  e.create = r;
  function i(n) {
    let t = n;
...
(function(e) {
  ...
  function i(n) {
    const t = n;
    return o.objectLiteral(t) && h.is(t.range) && O.is(t.color);
  }
  e.is = i;
})(K || (K = {}));
var ee;
(function(e) {
  ...
  function i(n) {
    const t = n;
    return o.objectLiteral(t) && o.string(t.label) && (o.undefined(t.textEdit) || E.is(t)) && (o.undefined(t.additionalTextEdits) || o.typedArray(t.additionalTextEdits, E.is));
  }
  e.is = i;
})(ee || (ee = {}));
var A;
...
var te;
(function(e) {
  function r(n, t, a, s, u, l) {
    const d = {
      startLine: n,
      endLine: t
    };
    return o.defined(a) && (d.startCharacter = a), o.defined(s) && (d.endCharacter = s), o.defined(u) && (d.kind = u), o.defined(l) && (d.collapsedText = l), d;
  }
  e.create = r;
  function i(n) {
    const t = n;
...
(function(e) {
  ...
  function i(n) {
    let t = n;
    return o.defined(t) && C.is(t.location) && o.string(t.message);
  }
  e.is = i;
})(U || (U = {}));
var x;
...
(function(e) {
  function r(n, t, a, s, u, l) {
    let d = { range: n, message: t };
    return o.defined(a) && (d.severity = a), o.defined(s) && (d.code = s), o.defined(u) && (d.source = u), o.defined(l) && (d.relatedInformation = l), d;
  }
  e.create = r;
  function i(n) {
    var t;
    let a = n;
    return o.defined(a) && h.is(a.range) && o.string(a.message) && (o.number(a.severity) || o.undefined(a.severity)) && (o.integer(a.code) || o.string(a.code) || o.undefined(a.code)) && (o.undefined(a.codeDescription) || o.string((t = a.codeDescription) === null || t === void 0 ? void 0 : t.href)) && (o.string(a.source) || o.undefined(a.source)) && (o.undefined(a.relatedInformation) || o.typedArray(a.relatedInformation, U.is));
  }
  e.is = i;
})(F || (F = {}));
var I;
...
(function(e) {
  ...
  function t(a) {
    const s = a;
    return o.objectLiteral(s) && o.string(s.newText) && h.is(s.range);
  }
  e.is = t;
})(E || (E = {}));
var V;
...
(function(e) {
  ...
  function i(n) {
    let t = n;
    return o.defined(t) && B.is(t.textDocument) && Array.isArray(t.edits);
  }
  e.is = i;
})(W || (W = {}));
var H;
(function(e) {
  ...
  function i(n) {
    let t = n;
    return t && t.kind === "create" && o.string(t.uri) && (t.options === void 0 || (t.options.overwrite === void 0 || o.boolean(t.options.overwrite)) && (t.options.ignoreIfExists === void 0 || o.boolean(t.options.ignoreIfExists))) && (t.annotationId === void 0 || L.is(t.annotationId));
  }
  e.is = i;
})(H || (H = {}));
var X;
(function(e) {
  ...
  function i(n) {
    let t = n;
    return t && t.kind === "rename" && o.string(t.oldUri) && o.string(t.newUri) && (t.options === void 0 || (t.options.overwrite === void 0 || o.boolean(t.options.overwrite)) && (t.options.ignoreIfExists === void 0 || o.boolean(t.options.ignoreIfExists))) && (t.annotationId === void 0 || L.is(t.annotationId));
  }
  e.is = i;
})(X || (X = {}));
var $;
(function(e) {
  ...
  function i(n) {
    let t = n;
    return t && t.kind === "delete" && o.string(t.uri) && (t.options === void 0 || (t.options.recursive === void 0 || o.boolean(t.options.recursive)) && (t.options.ignoreIfNotExists === void 0 || o.boolean(t.options.ignoreIfNotExists))) && (t.annotationId === void 0 || L.is(t.annotationId));
  }
  e.is = i;
})($ || ($ = {}));
var z;
(function(e) {
  function r(i) {
    let n = i;
    return n && (n.changes !== void 0 || n.documentChanges !== void 0) && (n.documentChanges === void 0 || n.documentChanges.every((t) => o.string(t.kind) ? H.is(t) || X.is(t) || $.is(t) : W.is(t)));
  }
  e.is = r;
})(z || (z = {}));
var ae;
...
(function(e) {
  function r(n, t, a, s) {
    return { uri: n, languageId: t, version: a, text: s };
  }
  e.create = r;
  function i(n) {
    let t = n;
...
(function(e) {
  function r(i) {
    const n = i;
    return o.objectLiteral(i) && q.is(n.kind) && o.string(n.value);
  }
  e.is = r;
})(P || (P = {}));
var p;
...
(function(e) {
  function r(i) {
    let n = i;
    return !!n && o.objectLiteral(n) && (P.is(n.contents) || y.is(n.contents) || o.typedArray(n.contents, y.is)) && (i.range === void 0 || h.is(i.range));
  }
  e.is = r;
})(he || (he = {}));
var pe;
...
(function(e) {
  function r(i, n, ...t) {
    let a = { label: i };
    return o.defined(n) && (a.documentation = n), o.defined(t) ? a.parameters = t : a.parameters = [], a;
  }
  e.create = r;
})(ve || (ve = {}));
var R;
...
(function(e) {
  function r(i, n, t, a) {
    return a !== void 0 ? { name: i, kind: n, location: { uri: t, range: a } } : { name: i, kind: n, location: { uri: t } };
  }
  e.create = r;
})(be || (be = {}));
var ke;
(function(e) {
  function r(n, t, a, s, u, l) {
    ...
    return l !== void 0 && (d.children = l), d;
  }
  e.create = r;
  function i(n) {
    let t = n;
...
(function(e) {
  function r(n, t, a) {
    let s = { diagnostics: n };
    return t != null && (s.only = t), a != null && (s.triggerKind = a), s;
  }
  e.create = r;
  function i(n) {
    let t = n;
    return o.defined(t) && o.typedArray(t.diagnostics, F.is) && (t.only === void 0 || o.typedArray(t.only, o.string)) && (t.triggerKind === void 0 || t.triggerKind === j.Invoked || t.triggerKind === j.Automatic);
  }
  e.is = i;
})(Ie || (Ie = {}));
var Ee;
(function(e) {
  function r(n, t, a) {
    let s = { title: n }, u = !0;
    return typeof t == "string" ? (u = !1, s.kind = t) : I.is(t) ? s.command = t : s.edit = t, u && a !== void 0 && (s.kind = a), s;
  }
  e.create = r;
  function i(n) {
    let t = n;
    return t && o.string(t.title) && (t.diagnostics === void 0 || o.typedArray(t.diagnostics, F.is)) && (t.kind === void 0 || o.string(t.kind)) && (t.edit !== void 0 || t.command !== void 0) && (t.command === void 0 || I.is(t.command)) && (t.isPreferred === void 0 || o.boolean(t.isPreferred)) && (t.edit === void 0 || z.is(t.edit));
  }
  e.is = i;
})(Ee || (Ee = {}));
var Le;
(function(e) {
  ...
  function i(n) {
    let t = n;
    return o.defined(t) && h.is(t.range) && (o.undefined(t.command) || I.is(t.command));
  }
  e.is = i;
})(Le || (Le = {}));
var Ae;
...
(function(e) {
  function r(n, t, a) {
    return { range: n, variableName: t, caseSensitiveLookup: a };
  }
  e.create = r;
  function i(n) {
    const t = n;
...
(function(e) {
  ...
  function i(n) {
    const t = n;
    return o.defined(t) && h.is(n.stoppedLocation);
  }
  e.is = i;
})(Ne || (Ne = {}));
var T;
...
(function(e) {
  ...
  function i(n) {
    const t = n;
    return o.objectLiteral(t) && (t.tooltip === void 0 || o.string(t.tooltip) || P.is(t.tooltip)) && (t.location === void 0 || C.is(t.location)) && (t.command === void 0 || I.is(t.command));
  }
  e.is = i;
})(G || (G = {}));
var Se;
(function(e) {
  ...
  function i(n) {
    const t = n;
    return o.objectLiteral(t) && b.is(t.position) && (o.string(t.label) || o.typedArray(t.label, G.is)) && (t.kind === void 0 || T.is(t.kind)) && t.textEdits === void 0 || o.typedArray(t.textEdits, E.is) && (t.tooltip === void 0 || o.string(t.tooltip) || P.is(t.tooltip)) && (t.paddingLeft === void 0 || o.boolean(t.paddingLeft)) && (t.paddingRight === void 0 || o.boolean(t.paddingRight));
  }
  e.is = i;
})(Se || (Se = {}));
var Oe;
...
(function(e) {
  function r(i, n, t, a) {
    return { insertText: i, filterText: n, range: t, command: a };
  }
  e.create = r;
})(Ue || (Ue = {}));
var Ve;
...
(function(e) {
  function r(i) {
    const n = i;
    return o.objectLiteral(n) && S.is(n.uri) && o.string(n.name);
  }
  e.is = r;
})($e || ($e = {}));
var ze;
(function(e) {
  ...
  function n(a, s) {
    ...
    for (let g = l.length - 1; g >= 0; g--) {
      let _ = l[g], w = a.offsetAt(_.range.start), f = a.offsetAt(_.range.end);
      if (f <= d)
        u = u.substring(0, w) + _.newText + u.substring(f, u.length);
      else
  ...
  function t(a, s) {
    if (a.length <= 1)
      return a;
    const u = a.length / 2 | 0, l = a.slice(0, u), d = a.slice(u);
    t(l, s), t(d, s);
    let g = 0, _ = 0, w = 0;
    for (; g < l.length && _ < d.length; )
      s(l[g], d[_]) <= 0 ? a[w++] = l[g++] : a[w++] = d[_++];
    for (; g < l.length; )
      a[w++] = l[g++];
    for (; _ < d.length; )
      a[w++] = d[_++];
...
(function(e) {
  ...
  e.boolean = t;
  function a(f) {
    return r.call(f) === "[object String]";
  }
  e.string = a;
  function s(f) {
    return r.call(f) === "[object Number]";
  }
  e.number = s;
  function u(f, N, dt) {
    return r.call(f) === "[object Number]" && N <= f && f <= dt;
  }
  e.numberRange = u;
  function l(f) {
    return r.call(f) === "[object Number]" && -2147483648 <= f && f <= 2147483647;
  }
  e.integer = l;
  function d(f) {
    return r.call(f) === "[object Number]" && 0 <= f && f <= 2147483647;
  }
  e.uinteger = d;
  function g(f) {
    return r.call(f) === "[object Function]";
  }
  e.func = g;
  function _(f) {
  ...
  e.objectLiteral = _;
  function w(f, N) {
    return Array.isArray(f) && f.every(N);
  }
  e.typedArray = w;
})(o || (o = {}));
var yt = class {
  constructor(e, r, i) {
    ...
    this._disposables.push(c.editor.onDidCreateModel(n)), this._disposables.push(c.editor.onWillDisposeModel(t)), this._disposables.push(
  ...
  _doValidate(e, r) {
    this._worker(e).then((i) => i.doValidation(e.toString())).then((i) => {
      const n = i.map((a) => kt(e, a));
      let t = c.editor.getModel(e);
      t && t.getLanguageId() === r && c.editor.setModelMarkers(t, r, n);
    }).then(void 0, (i) => {
      console.error(i);
    });
  }
...
var xt = class {
  ...
  provideCompletionItems(e, r, i, n) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doComplete(t.toString(), k(r))).then((a) => {
      if (!a)
        return;
      const s = e.getWordUntilPosition(r), u = new c.Range(
        r.lineNumber,
        s.startColumn,
        r.lineNumber,
        s.endColumn
...
function Et(e) {
  const r = c.languages.CompletionItemKind;
  switch (e) {
    case p.Text:
      return r.Text;
    case p.Method:
...
var Ge = class {
  ...
  provideHover(e, r, i) {
    let n = e.uri;
    return this._worker(n).then((t) => t.doHover(n.toString(), k(r))).then((t) => {
      if (t)
        return {
          range: m(t.range),
...
var Je = class {
  ...
  provideDocumentHighlights(e, r, i) {
    const n = e.uri;
    return this._worker(n).then((t) => t.findDocumentHighlights(n.toString(), k(r))).then((t) => {
      if (t)
        return t.map((a) => ({
          range: m(a.range),
          kind: Pt(a.kind)
...
var jt = class {
  ...
  provideDefinition(e, r, i) {
    const n = e.uri;
    return this._worker(n).then((t) => t.findDefinition(n.toString(), k(r))).then((t) => {
      if (t)
        return [Ye(t)];
    });
  }
...
var Nt = class {
  ...
  provideReferences(e, r, i, n) {
    const t = e.uri;
    return this._worker(t).then((a) => a.findReferences(t.toString(), k(r))).then((a) => {
      if (a)
        return a.map(Ye);
    });
  }
  ...
  provideRenameEdits(e, r, i, n) {
    const t = e.uri;
    return this._worker(t).then((a) => a.doRename(t.toString(), k(r), i)).then((a) => Dt(a));
  }
};
function Dt(e) {
  if (!e || !e.changes)
...
function et(e) {
  return {
    ...
    tags: e.tags ?? [],
    children: (e.children ?? []).map((r) => et(r))
  };
}
function tt(e) {
  let r = c.languages.SymbolKind;
  switch (e) {
    case v.File:
      return r.File;
    case v.Module:
...
var nt = class {
  ...
  provideDocumentFormattingEdits(e, r, i) {
    const n = e.uri;
    return this._worker(n).then((t) => t.format(n.toString(), null, at(r)).then((a) => {
      if (!(!a || a.length === 0))
        return a.map(D);
    }));
  }
  ...
  provideDocumentRangeFormattingEdits(e, r, i, n) {
    const t = e.uri;
    return this._worker(t).then((a) => a.format(t.toString(), Te(r), at(i)).then((s) => {
      if (!(!s || s.length === 0))
        return s.map(D);
    }));
  }
...
var St = class {
  ...
  provideColorPresentations(e, r, i) {
    ...
    return this._worker(n).then(
      (t) => t.getColorPresentations(n.toString(), r.color, Te(r.range))
    ).then((t) => {
      if (t)
        return t.map((a) => {
          let s = {
          ...
          return a.textEdit && (s.textEdit = D(a.textEdit)), a.additionalTextEdits && (s.additionalTextEdits = a.additionalTextEdits.map(D)), s;
        });
    });
  }
}, ot = class {
    ...
    return this._worker(n).then(
      ...
      if (t)
        return t.map((a) => {
          const s = [];
          for (; a; )
            s.push({ range: m(a.range) }), a = a.parent;
          return s;
        });
    });
  }
...
function Ot(e) {
  const r = new Qe(e), i = (...t) => r.getLanguageServiceWorker(...t);
  let n = e.languageId;
  c.languages.registerCompletionItemProvider(n, new ut(i)), c.languages.registerHoverProvider(n, new Ge(i)), c.languages.registerDocumentHighlightProvider(
    n,
    new Je(i)
  ), c.languages.registerLinkProvider(n, new nt(i)), c.languages.registerFoldingRangeProvider(
    n,
    new ot(i)
    ...
    n,
    new st(i)
  ), c.languages.registerRenameProvider(n, new Ze(i)), n === "html" && (c.languages.registerDocumentFormattingEditProvider(
    n,
    new rt(i)
...
function Ut(e) {
  const r = [], i = [], n = new Qe(e);
  r.push(n);
  const t = (...s) => n.getLanguageServiceWorker(...s);
  function a() {
...
export {
  ...
  rt as DocumentFormattingEditProvider,
